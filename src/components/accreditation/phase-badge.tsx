...
const phaseConfig: Record<string, { label: string; color: string; icon: typeof HardHat }> = {
  BUMP_IN: { label: 'Bump-In', color: 'bg-blue-100 text-blue-800', icon: HardHat },
  LIVE: { label: 'Live', color: 'bg-green-100 text-green-800', icon: Radio },
  BUMP_OUT: { label: 'Bump-Out', color: 'bg-orange-100 text-orange-800', icon: PackageOpen },
};
