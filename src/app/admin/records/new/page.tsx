  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {!project ? (
          <p className="text-gray-500">Loading active event...</p>
        ) : (
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-24 h-24 rounded-lg bg-gray-200 flex items-center justify-center cursor-pointer hover:bg-gray-300 transition-colors overflow-hidden" onClick={() => fileInputRef.current?.click()}>
                      {photoPreview ? (
